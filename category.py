...
max_len = 100
file_path_word2vec = 'model/word2vec_category.pkl'
file_path_lstm = 'model/category.h5'
...
if __name__ == '__main__':
    ...
    label_dic = {0: '包装', 1: '成分', 2: '尺寸', 3: '服务', 4: '功效', 5: '价格', 6: '气味', 7: '使用体验', 8: '物流', 9: '新鲜度',
                 10: '真伪', 11: '整体', 12: '其他'}
    output = []
    asp_opi_string, test_asp_opi = read_task(task='task1')
    ...
    with open('Test/task2_answer.csv', 'w', encoding='utf-8') as f:
        for sent in output:
            f.write(sent)
